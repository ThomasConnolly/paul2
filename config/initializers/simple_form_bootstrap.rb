...
SimpleForm.setup do |config|
  ...
  config.wrappers(:vertical_collection_inline,
                  item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-3') do |b|
    b.use(:html5)
    b.optional(:readonly)
    b.wrapper(:legend_tag, tag: 'legend', class: 'col-form-label pt-0') do |ba|
      ba.use(:label_text)
  ...
  config.wrappers(:horizontal_collection_inline,
                  item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'row mb-3') do |b|
    b.use(:html5)
    b.optional(:readonly)
    b.use(:label, class: 'col-sm-3 col-form-label pt-0')
    b.wrapper(:grid_wrapper, class: 'col-sm-9') do |ba|
